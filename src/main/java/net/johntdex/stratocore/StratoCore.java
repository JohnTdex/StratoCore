...
@Mod(StratoCore.MODID)
public class StratoCore {
    // Define mod id in a common place for everything to reference
    public static final String MODID = "stratocore";
    ...
    public StratoCore(IEventBus modEventBus, ModContainer modContainer) {
        ...
        StratoCoreCreativeTab.register(modEventBus);
